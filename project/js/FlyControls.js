...
THREE.FlyControls = function ( player, domElement) {

	this.object = player.gun;
    this.player = player;
	...
	this.update = function( delta, rotOnly ) {
	...
	this.updateMovementVector = function() {
		...
		//this.moveVector.y = speed*( -this.moveState.down    + this.moveState.up );
